...
WHERE NOT EXISTS (SELECT 1 FROM users WHERE username = 'alvaro2');
...
WHERE NOT EXISTS (SELECT 1 FROM games WHERE name = 'Filler Game Alpha');
...
WHERE NOT EXISTS (SELECT 1 FROM games WHERE name = 'Filler Game Beta');
...
WHERE NOT EXISTS (SELECT 1 FROM games WHERE name = 'Filler Game Gamma');
...
WHERE NOT EXISTS (SELECT 1 FROM games WHERE name = 'Filler Game Delta');
...
WHERE NOT EXISTS (SELECT 1 FROM games WHERE name = 'Filler Game Epsilon');
